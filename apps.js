...
const appList = [
  ...
  {
    name: "App Store",
    icon: "https://apps.microsoft.com/assets/icons/logo-256x256.png",
  ...
  }
  {
    name: "Human or Not",
    icon: "https://static-00.iconduck.com/assets.00/vault-icon-512x483-w9kgke5x.png",
    content: "app/humanornot.html",
    installed: false,
    preinstalled: false,
    description: "Figure out whether the person you are talking to is human or not."
  }
];
